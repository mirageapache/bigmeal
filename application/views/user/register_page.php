		...
		<table class="fill_in_table">
			<tr>
				<td>
					...
					<input class="account form-control" type="text" placeholder="輸入英文或數字8-20個字" maxlength="20" />
				</td>
			</tr>
			<tr>
				<td>
					<label class="title">密碼</label><label class="hint password_hint pull-right"></label>
					<input class="password form-control" type="password" placeholder="輸入英文或數字8-20個字" maxlength="20" />
				</td>
			</tr>
			<tr>
				<td>
					<label class="title">確認密碼</label><label class="hint confirm_hint pull-right"></label>
					<input class="password_confirm form-control" type="password" placeholder="再次輸入密碼" maxlength="20"/>
				</td>
			</tr>
			<tr>
				<td>
					<label class="title">E-mail</label><label class="hint eamil_hint pull-right"></label>
					<input class="email form-control" type="email" placeholder="XXXXXXX@XX.XX" maxlength="50"/>
				</td>
			</tr>
		</table>
		<!-- <hr>
